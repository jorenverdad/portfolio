      ...
      >
        ...
        <m.div variants={itemVariants} className="flex flex-col gap-4 max-w-sm">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-mono uppercase tracking-[0.3em] text-brand-500">
              Live Telemetry
            </span>
          </div>
          ...
          <p className="text-sm font-sans text-muted-foreground/80 leading-relaxed font-light mt-2">
            Real-time data fetched directly from GitHub. A quantitative look at
            my contributions, public repositories, and community impact.
          </p>
        </m.div>
