      ...
      <div className="lg:col-span-4 lg:sticky lg:top-32 h-fit flex flex-col gap-6 journey-left-column">
        <div>
          ...
          <p className="text-muted-foreground text-base leading-relaxed font-sans max-w-md">
            A trace of system architecture, team leadership, and interactive
            design milestones.
          </p>
        </div>
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span
                      className={`text-[10px] ${activeIndex === index ? "text-brand-500" : "text-muted-foreground/30"}`}
                    >
                      0{index + 1}
                    </span>
                  ...
                  <ChevronRight
                    className={`size-3.5 transition-transform duration-300 ${activeIndex === index ? "translate-x-0.5 text-brand-500" : "text-muted-foreground/30"}`}
                  />
                </button>
              ))}
            </div>
          ...
          {milestones.map((milestone, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className={`absolute inset-0 bg-radial from-brand-500/5 via-transparent to-transparent pointer-events-none transition-opacity duration-700 ${
                      isActive
                        ? "opacity-100"
