  ...
  return (
    <div className="relative w-36 h-36 mx-auto flex items-center justify-center select-none">
      ...
      <div
        ...
        style={{
          background:
            "conic-gradient(from 0deg, transparent 0%, transparent 50%, oklch(0.56 0.215 25 / 0.02) 60%, oklch(0.56 0.215 25 / 0.1) 85%, oklch(0.56 0.215 25 / 0.22) 100%)",
      ...
      <svg
        className="w-full h-full text-brand-500/15 pointer-events-none z-10"
        viewBox="0 0 100 100"
      >
        <circle
          cx="50"
        ...
        <circle
          ...
          r="42"
          fill="none"
          stroke="oklch(0.56 0.215 25 / 0.05)"
          strokeWidth="4"
        />
        ...
        <text
          ...
          className="fill-brand-500/40 font-mono text-[3.5px] font-bold"
        >
          00
        </text>
        <text
      ...
      >
        ...
        >
          <span className="absolute -bottom-3.5 left-[-4px] font-mono text-[5px] text-brand-100/80 bg-bg-void/90 px-0.5 border border-brand-500/20 rounded-sm scale-90 origin-left">
            TRK-2025
          </span>
        </div>
      </div>
    ...
    <div className="relative w-36 h-36 mx-auto flex items-center justify-center select-none mb-2">
      ...
      >
        ...
        <text
          ...
          textAnchor="middle"
          dominantBaseline="middle"
          className="fill-brand-100/80 font-mono text-[4px] uppercase tracking-wider font-semibold"
        >
          GPA
        </text>
      </svg>
...
export function CertificationsTelemetryDashboard() {
  ...
  return (
    <div className="w-full bg-bg-void/60 border border-edge-subtle/70 rounded-2xl p-4.5 font-mono text-[9.5px] text-brand-100 flex flex-col gap-2 min-h-[145px] shadow-inner select-none relative overflow-hidden text-left">
      ...
      <div className="flex-1 flex flex-col gap-1.5 text-brand-100/90 font-medium">
        {log.map((line, idx) => (
  ...
  return (
    <div className="flex flex-col gap-3.5 border border-edge-subtle/50 bg-bg-surface/10 rounded-2xl p-4.5 select-none text-left">
      <div className="flex justify-between items-center text-[9px] font-mono text-muted-foreground/50 font-bold uppercase tracking-wider">
        ...
        <span className="text-brand-100">Node: OS-CONTRIB</span>
      </div>
